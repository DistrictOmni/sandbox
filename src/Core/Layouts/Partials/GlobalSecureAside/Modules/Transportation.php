<!-- TRANSPORTATION (HOVER sub-drawer) -->
<li 
  class="relative w-full"
  @mouseenter="openDropdown = 'transportationDrawer'"
  @mouseleave="openDropdown = (openDropdown === 'transportationDrawer') ? null : openDropdown"
>
  <!-- Trigger for Transportation Drawer -->
  <div 
    ...
    aria-label="Transportation Drawer"
  >
    <i class="fas fa-bus-alt text-2xl" aria-hidden="true"></i>
    <span class="text-sm mt-1">Transportation</span>
  </div>

  <!-- The Drawer Itself (fixed, multi-column) -->
  <div 
    x-show="openDropdown === 'transportationDrawer'"
